...
public class HboIct {
    ...
    public static void hype(@NotNull String path, @NotNull Consumer<SseClient> client) {
        staticInstance().sse(prefixPath(path), client);
    }

    public static void hype(@NotNull String path, @NotNull Consumer<SseClient> client, @NotNull Set<Role> permittedRoles) {
        staticInstance().sse(prefixPath(path), client, permittedRoles);
    }

    public static void hype(@NotNull Consumer<SseClient> client) {
        staticInstance().sse(prefixPath(""), client);
    }

    public static void hype(@NotNull Consumer<SseClient> client, @NotNull Set<Role> permittedRoles) {
